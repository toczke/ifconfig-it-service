...
import styles from './IfconfigLogo.module.css';
...
const IfconfigLogo: React.FC<IfconfigLogoProps> = ({
  width = 512,
  height = 134,
  className = '',
  theme = 'auto',
  primaryColor: propPrimaryColor,
  chevronColor: propChevronColor,
  gradientFrom = '#0284C7',
  gradientTo = '#2563EB',
}) => {
  const { colorScheme } = useMantineColorScheme();
  const themeClass = theme === 'auto' ? '' : styles[`theme-${theme}`];
  ...
  return (
    <svg
      className={`${styles.logo} ${themeClass} ${className}`}
      viewBox="0 0 512 134"
      width={width}
      height={height}
      xmlns="http://www.w3.org/2000/svg"
      aria-label="ifconfig logo"
      role="img"
    >
      <defs>
      ...
      <path
        fill={`url(#${gradientId})`}
        d="m133.3 67c0-37-29.9-67-66.7-67-36.8 0-66.6 30-66.6 67 0 37 29.8 67 66.6 67 36.8 0 66.7-30 66.7-67z"
      />
      ...
      <path
        fill={chevronColor}
        d="m89.3 64.9q0 3-0.6 5.3h-6.6q0.5 2.1 0.5 5.3 0 3-0.5 5.3h-6.6q0.5 2.1 0.5 5.3 0 3-0.5 5.3h-6.6q0.5 2.1 0.5 5.3 0 3-0.5 5.3h-10.6q-0.6-2.3-0.6-5.3 0-3.2 0.6-5.3h6.6q-0.5-2.3-0.5-5.3 0-3.2 0.5-5.3h6.6q-0.5-2.3-0.5-5.3 0-3.2 0.5-5.3h6.6q-0.5-2.3-0.5-5.3 0-3.2 0.5-5.3h-6.6q-0.5-2.3-0.5-5.3 0-3.2 0.5-5.3h-6.6q-0.5-2.3-0.5-5.3 0-3.2 0.5-5.3h-6.6q-0.6-2.3-0.6-5.3 0-3.2 0.6-5.3h10.6q0.5 2.1 0.5 5.3 0 3-0.5 5.3h6.6q0.5 2.1 0.5 5.3 0 3-0.5 5.3h6.6q0.5 2.1 0.5 5.3 0 3-0.5 5.3h6.6q0.6 2.1 0.6 5.3z"
      />
    </svg>
  );
};

export default IfconfigLogo;